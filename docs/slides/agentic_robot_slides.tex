...
\begin{itemize}
  ...
  \item 本报告核实 207 篇论文（46 核心 / 94 扩展 / 67 基础）后回答三个问题：
  \begin{itemize}
...
\end{block}
\en{Source materials: the Xiaohongshu essay by 具身RL日记, the Code-as-Policy deck, the 23-line retrieval map, Lilian Weng's Lil'Log posts (2023, 2026), and the 具身纪元 WeChat essay on Robot RSI by Marilyn Liu.}
\end{frame}
...
\end{columns}
\vspace{4pt}
\en{Full line-by-line survey in report Section 4; 207 papers on 25 lines in README.}
\end{frame}
...
\en{README（207 篇论文 / 25 主线）· 中英文报告 PDF · HTML 幻灯片 · SuperTranslate 中文译本}
\end{frame}
