...
\begin{itemize}
  ...
  \item 本报告核实 169 篇论文（46 核心 / 94 扩展 / 29 基础）后回答三个问题：
  \begin{itemize}
...
\end{columns}
\vspace{4pt}
\en{Full line-by-line survey in report Section 4; 169 papers on 25 lines in README.}
\end{frame}
...
\en{README（169 篇论文 / 25 主线）· 中英文报告 PDF · HTML 幻灯片 · SuperTranslate 中文译本}
\end{frame}
